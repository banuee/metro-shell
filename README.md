...
### 4. Встроенный конфигуратор виджетов-команд (ExecWidget)
> *Акриловый Expand-конфигуратор: кастомное название, выполнение в терминале (`kitty`) или тихо в фоне, 14 глифов Nerd Font, готовые пресеты (обновление, fastfetch, btop, кэш) и живой предпросмотр.*

![Конфигуратор команд](assets/screenshots/04_exec_config_expanded.png)

---

### 5. Лаунчер приложений и закреплённые (Favorites)
...
### 6. Центр управления и панель уведомлений
...
### 7. Центр настроек Metro Settings
...
- 💎 **Metro & Glass Дизайн**: Глубокий блюр, полупрозрачные акриловые подложки (`Theme.glass`), утончённая типографика (Segoe UI Variable / NotoSans Nerd Font) и гармоничные акцентные цвета.
