...
QtObject {
    ...
    // СВОЯ тема тулбара (metro-colors пишет сюда ТОЛЬКО teal-строку):
    // плотный тёмный фон — блюр цепляется, ignore_alpha 0.2 его не съедает.
    readonly property color glassDeep: Qt.rgba(0.08, 0.08, 0.10, 0.78)
